...
class Widget(QWidget):
    def __init__(self):
        ...
        self.items = 0
        #Dummy Data For Opening The Diagram
        self._data = {"Water": 24, "Rent": 1000, "Coffee": 30,"Grocery": 300, "Phone": 45, "Internet": 70}

        # Left Widget
        self.table = QTableWidget()
        self.table.setColumnCount(2)
        self.table.setHorizontalHeaderLabels(["Deskripsi", "Harga"])
        ...
        self.right.addWidget(QLabel("Deskripsi"))
        self.right.addWidget(self.description)
        self.right.addWidget(QLabel("Harga"))
    ...
    def add_element(self):
        ...
        try:
            ...
            print("Invalid Input!!", "Silahkan Ketik Ulang Harga Yang Valid!")
...
class MainWindow(QMainWindow):
    def __init__(self, widget):
        ...
        self.setWindowTitle("Tugas Ujian Akhir Semester (Expense Tracker)")
